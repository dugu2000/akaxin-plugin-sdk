...
class HaiPluginListResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .core.Plugin plugin = 1;</code>
     * @param \Akaxin\Proto\Core\Plugin[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlugin($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Akaxin\Proto\Core\Plugin::class);
        $this->plugin = $arr;
